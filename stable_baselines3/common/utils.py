...
def is_vectorized_observation(
    ...
    if CLASSIC_SPACES is not None:
        ...
        is_vec_obs_func_dict.update(
            {
                CLASSIC_SPACES.Box: is_vectorized_box_observation,
                CLASSIC_SPACES.Discrete: is_vectorized_discrete_observation,
                CLASSIC_SPACES.MultiDiscrete: is_vectorized_multidiscrete_observation,
                CLASSIC_SPACES.MultiBinary: is_vectorized_multibinary_observation,
            }
        )
